...
const LogoItem = ({ src, alt }) => (
  <motion.div
    ...
    whileTap={{ scale: 0.95 }}
  >
    <img src={src} alt={alt} className="w-full rounded-md h-full object-contain" />
  </motion.div>
);
...
const MovingLogosRow = ({ direction = "left", className = "" }) => {
  const logos = [
    ...
    { src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkwguzKZv5vwJ0B79_KQtB9_u0MQt18FHfkQ&s", alt: "AI Tool 2" },
    { src: "https://play-lh.googleusercontent.com/q2QO-v3lVxaAnBPvS0JT9G4zoWFQTW6QQJOCt-EbawQiurq0B2vybZjXcJvJpGHyl0Bh", alt: "AI Tool 3" },
    { src: "/api/placeholder/48/48", alt: "AI Tool 4" },
    { src: "/api/placeholder/48/48", alt: "AI Tool 5" },
    { src: "/api/placeholder/48/48", alt: "AI Tool 6" },
    { src: "/api/placeholder/48/48", alt: "AI Tool 7" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen bg-gradient-to-b  backdrop-blur-s">
        {/* Product Hunt Badge */}
        <div className="mb-12">
          <div className="bg-gray-800/90 backdrop-blur-sm px-6 py-2 rounded-full flex items-center space-x-2">
          ...
          <div className="flex items-center justify-center gap-2">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full bg-gray-400 border-2 border-gray-800"
                />
              ))}
            </div>
